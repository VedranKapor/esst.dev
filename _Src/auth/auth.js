...
export class Auth {
    ...
    // static changeAdminPass(password, newpasword) {
    //     return new Promise((resolve, reject) => {

    //         if(password == '') reject({
    //             'msg': 'Pasword is required field!', "type": "ERRORCurrent"
    //         });
    //         if(newpasword == '') reject({
    //             'msg': 'New password is required field!', "type": "ERRORNew"
    //         })
    ...
    //             async: false,
    //             type: 'POST',
    //             data: { action: 'changePassword', userID: 'null', currentpassword: password, newpassword: newpasword },
    //             success: function (data) {
    //                 var serverResponce = JSON.parse(data);
    //                 switch (serverResponce["type"]) {
    //                     case 'ERRORCurrent':
